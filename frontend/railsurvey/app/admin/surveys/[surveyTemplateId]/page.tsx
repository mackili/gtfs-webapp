...
import { querySurveysTable, querySurveyTemplate } from "@/functions/dbQuery";
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="transition-all hover:bg-accent/10 hover:text-accent-foreground rounded-md p-4 has-[>svg]:px-4 flex flex-col border bg-background shadow-xs gap-4">
                        ...
                        {surveyData.map((survey, index) => (
                            ...
                            >
                                <InfocardsMap
                                    title={`${survey.surveyTemplateId} (${
                                        survey.isActive === true
                                            ? "Active"
                                            : "Inactive"
                                    })`}
                                    // @ts-expect-error its formatted correctly, other things are not displayed
                                    data={{
                                        ...survey,
                                        isActive: String(survey.isActive),
